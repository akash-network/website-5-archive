...
| --- | --- | --- | --- | --- |
| [Console Authorized Spend Support](../sig-clients/akash-console/prd-authorized-spend) | console-authz | Supporting Authorized Spend (AuthZ) in Akash Console | [sig-clients](../sig-clients/README) | implementation |
| [GPU Support](../wg-gpu/prd) | gpu | Everything related to supporting, launching and growing GPUs on Akash  | [wg-gpu](../wg-gpu) | implementation |
...
| [Economics 2.0](../sig-economics/akt20-prop) | econ-2.0 | Redesigning Akash Network's economics model to have fine grained take rates to fund product development and sustainability of the chain  | [sig-economics](../sig-economics/README) | spec-definition |
...
| [Stable payments & Settlement](../sig-economics/stable-payments-and-take-rate.md) | | Ability for tenants to pay for deployments using other cryptocurrencies | [sig-economics](../sig-economics/) | spec-definition |
